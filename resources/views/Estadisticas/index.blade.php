          ...
          <div class="row mb-3 g-3">
                ...
                <div class="card-body p-0">
                  ...
                  <table class="table table-sm" id="id_table">
                      <thead class="bg-light" >
                        <tr class="text-900" id='id_table_header'><th>Name</th></tr>                        
                      </thead>
                  ...
                  <div class="row align-items-center">
                    <div class="col-xxl-12 col-md-7">
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_farmacia">C$ 0.00</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">VENTA </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_VentaFarmacia">C$ 0.00 </h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">% CUMPL X EJEC </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_promo"> 0 % </h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">OPTIMO <div id="id_tt_lbl_optimo"></div> </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_optimo"> 0 %</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">CLIENTES</h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_cliente"> 0 %</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">META DE CLIENTES </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_cliente_meta"> 0 %</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_cliente_optimo" > 0 %</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_tendencia"> 0 %</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_ds"> 0 %</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_sku"> 0 %</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_isToday">C$ 0.00</h6>
                      </div>

                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">EJECT</h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_eject">C$ 0.00</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_sac">C$ 0.00</h6>
                      </div>
            ...
            <div class="col-xxl-9">
              <div class="card overflow-hidden">                
                <div class="card-body p-0">
                  <div class="table-responsive scrollbar">
                  <table class="table table-sm" id="id_table_proyecto_02">
                      <thead class="bg-light" >
                  ...
                  <div class="row align-items-center">
                    <div class="col-xxl-12 col-md-7">
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_farmacia_Pro02" >C$ 0.00</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0" >VENTA </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_VentaFarmacia_Pro02" > C$ 0.00 </h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0" >% CUMPL X EJEC </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_promo_pro02"> 0 %</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">OPTIMO <div id="id_tt_lbl_optimo_pro02"></div></h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_optimo_pro02"> 0 %</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">CLIENTES</h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_cliente_pro02"> 0.00</h6>
                      </div>
                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex">
                          <h6 class="text-700 mb-0">META DE CLIENTES </h6>
                        </div>
                        <h6 class="text-700 mb-0" id="id_tt_cliente_meta_pro02"> 0.00 </h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_cliente_optimo_pro02">53%</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_ds_pro02"> 0.00</h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3 ">
                        ...
                        <h6 class="text-700 mb-0"  id="id_tt_sku_pro02"> 0.00 </h6>
                      </div>
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        ...
                        <h6 class="text-700 mb-0" id="id_tt_eject_pro02">C$ 0.00</h6>
                      </div>
