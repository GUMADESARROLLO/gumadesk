                      ...
                      <div class="tab-content">
                        ...
                        <div class="row">
                          <div class="col-lg-3 border-lg-end border-bottom border-lg-0 pb-3 pb-lg-0">
                            ...
                            <div class="d-flex">
                              <div class="d-flex">
                                <p class="font-sans-serif lh-1 mb-1 fs-4 pe-2" id="id_tt_promo">15%</p>
                                <div class="d-flex flex-column"> <span class="badge badge-soft-success rounded-pill fs--2" id="id_tt_optimo" >0.00%</span>
                                  <p class="fs--2 mb-0 text-nowrap"> <span id="id_tt_VentaFarmacia"></span> / <span id="id_tt_farmacia"></span>  </p>
                                </div>
                              </div>
                          ...
                          <div class="col-lg-2 border-lg-end border-bottom border-lg-0 py-3 py-lg-0">
                            ...
                            <div class="d-flex">
                              <div class="d-flex">
                                <p class="font-sans-serif lh-1 mb-1 fs-4 pe-2" id="id_tt_cliente_optimo" >13%</p>
                          ...
                          <div class="col-lg-3 pt-3 pt-lg-0 border-lg-end border-bottom border-lg-0 py-3 py-lg-0">
                            <div class="d-flex">
                      ...
                      <div class="d-flex ">
                        ...
                        <div class="row">
                          <div class="col-lg-3 border-lg-end border-bottom border-lg-0 pb-3 pb-lg-0">
                            ...
                            <div class="d-flex">
                              <div class="d-flex">
                                <p class="font-sans-serif lh-1 mb-1 fs-4 pe-2" id="id_tt_promo_pro02">15%</p>
                                <div class="d-flex flex-column"> <span class="badge badge-soft-success rounded-pill fs--2" id="id_tt_lbl_optimo_pro02" >0.00%</span>
                                  <p class="fs--2 mb-0 text-nowrap"> <span id="id_tt_VentaFarmacia_Pro02"></span> / <span id="id_tt_farmacia_Pro02"></span>  </p>
                                </div>
                              </div>
                          ...
                          <div class="col-lg-3 border-lg-end border-bottom border-lg-0 py-3 py-lg-0">
                            ...
                            <div class="d-flex">
                              <div class="d-flex">
                                <p class="font-sans-serif lh-1 mb-1 fs-4 pe-2" id="id_tt_cliente_optimo_pro02" >13%</p>
